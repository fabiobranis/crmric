...
method getList(oJsonParam,nPage,nPageLength,nOrder,cDirection) class DA1TabPrecoItem
	...
	cQuery +=  "SELECT DA1_ITEM, DA1_CODTAB, DA1_CODPRO, B1_DESC, DA1_PRCVEN, DA1_VLRDES, DA1_GRUPO, DA1_REFGRD, DA1_PERDES, DA1_ATIVO, DA1_ESTADO, DA1_TPOPER, DA1_QTDLOT, DA1_INDLOT ,DA1_MOEDA, DA1_PRCMAX FROM "+ RetSqlName("DA1") +" DA1 "
